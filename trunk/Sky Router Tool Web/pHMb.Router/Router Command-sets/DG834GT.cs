...
namespace pHMb.Router.RouterCommandSets
{
    ...
    public class DG834GT : Busybox
    {
        ...
        {
            string bitLoadingText = _routerHttp.SendCommand("adslctl info --Bits");
        ...
        {
            string snrText = _routerHttp.SendCommand("adslctl info --SNR");
        ...
        {
            string qlnText = _routerHttp.SendCommand("adslctl info --QLN");
        ...
        {
            string hlogText = _routerHttp.SendCommand("adslctl info --Hlog");
        ...
        private ConnectionDetails GetConnectionDetails()
        {
            ...
            string conDetailsText = _routerHttp.SendCommand("adslctl info --stats");
        ...
        {
            private DG834GT _routerCommand;
            ...
            public RouterData(DG834GT routerCommand)
            {
        ...
        public DG834GT(RouterHttp routerHttp) : base(routerHttp) { }
        ...
        {
            _routerHttp.SendCommand(string.Format("adslctl configure --snr {0:N1}", targetSnrm));
        }
        ...
        {
            _routerHttp.SendCommand("adslctl connection --up");
        }
        #endregion
